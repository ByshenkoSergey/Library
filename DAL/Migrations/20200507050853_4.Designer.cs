            ...
            modelBuilder.Entity("DAL.Models.IdentityModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("286d81c9-ef6e-4670-9a81-7c01be151915"),
                            AccessFailedCount = 0,
                            ApplicationUserRoleId = new Guid("12354898-7456-3215-4895-123654879878"),
                            ConcurrencyStamp = "0eb2b2f9-02e1-4be8-a8bb-4e2037a4131b",
                        ...
                        new
                        {
                            UserId = new Guid("f6d4d858-ed87-4a47-895d-3f192557964b"),
                            AccessFailedCount = 0,
                            ApplicationUserRoleId = new Guid("12359876-5423-1564-8957-8215647acdfa"),
                            ConcurrencyStamp = "15eae353-5645-4cfc-a270-44ce94562832",
                        ...
                        new
                        {
                            UserId = new Guid("73614ed2-0752-4770-8151-5e06c72c9648"),
                            AccessFailedCount = 0,
                            ApplicationUserRoleId = new Guid("a75489d7-8542-315f-f961-a254892c8a32"),
                            ConcurrencyStamp = "1ed5d939-584f-4973-98e4-2c787b83f570",
            ...
            modelBuilder.Entity("DAL.Models.IdentityModels.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "e60e2f3a-11ba-4ec1-9982-fbdf5129192e",
                            RoleName = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("a75489d7-8542-315f-f961-a254892c8a32"),
                            ConcurrencyStamp = "e4cc4a55-1a06-49d0-9476-60bb824a4fa7",
                            RoleName = "User"
                        },
                        new
                        {
                            RoleId = new Guid("a7548337-8541-515f-f961-a25489212a32"),
                            ConcurrencyStamp = "52a93016-d046-41ef-951f-76e75dd27bd1",
                            RoleName = "SuperUser"
                        },
                        new
                        {
                            RoleId = new Guid("12359876-5423-1564-8957-8215647acdfa"),
                            ConcurrencyStamp = "cf9c7424-5ef0-4b48-97f4-03fd8facec8d",
                            RoleName = "Moderator"
                        });
                });
