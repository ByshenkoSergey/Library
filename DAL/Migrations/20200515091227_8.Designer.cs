            ...
            modelBuilder.Entity("DAL.Models.IdentityModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("0b882bc1-48b0-42c6-ae48-01ebd2c8615b"),
                            AccessFailedCount = 0,
                            ApplicationUserRoleId = new Guid("12354898-7456-3215-4895-123654879878"),
                            ConcurrencyStamp = "f8b1b210-fa19-4f31-af36-e1bc93303bff",
                        ...
                        new
                        {
                            UserId = new Guid("c6733bb3-6f8e-4334-8c0f-4423f872ec7d"),
                            AccessFailedCount = 0,
                            ApplicationUserRoleId = new Guid("12359876-5423-1564-8957-8215647acdfa"),
                            ConcurrencyStamp = "044d652a-9115-42d7-820b-5db80e83e45d",
                        ...
                        new
                        {
                            UserId = new Guid("86824418-b84d-41f6-9bbb-24618f13eb23"),
                            AccessFailedCount = 0,
                            ApplicationUserRoleId = new Guid("a75489d7-8542-315f-f961-a254892c8a32"),
                            ConcurrencyStamp = "298ec7be-651e-49cd-bf61-7885f705adda",
                        ...
                        new
                        {
                            UserId = new Guid("3205c51c-4cc7-418d-84b2-8e7d12ea3507"),
                            AccessFailedCount = 0,
                            ApplicationUserRoleId = new Guid("a7548337-8541-515f-f961-a25489212a32"),
                            ConcurrencyStamp = "303ccc82-1432-4119-8900-ce906a8530dd",
            ...
            modelBuilder.Entity("DAL.Models.IdentityModels.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "64a433d2-8e4c-45a3-8f9a-32f0f4dfa0e6",
...
3. View all users;
 ...
 6. Change your profile;",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "1542ce22-ff6b-46eb-a309-199b1e4d634e",
                            RoleInfo = @"Key challenges and opportunities:
...
",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "7dca1cd4-fddc-4b96-9abd-4c62b60c6f2c",
                            RoleInfo = @"Key challenges and opportunities:
 1. Chenge your profile;
 2. View all books;
3. Serch books;
...
",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "8aeae25c-4b87-4274-9881-95d673319b25",
                            RoleInfo = @"Key challenges and opportunities:
 1. Chenge your profile;
 2. View all books;
3. View all authors;
