            ...
            modelBuilder.Entity("DAL.Models.IdentityModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("719cd470-2991-4906-98fd-aa821a3c1d58"),
                            AccessFailedCount = 0,
                            ApplicationUserRoleId = new Guid("12354898-7456-3215-4895-123654879878"),
                            ConcurrencyStamp = "0caa0459-e3fa-4bf2-8ce5-6650bd938361",
                        ...
                        new
                        {
                            UserId = new Guid("891a9328-01c0-47d2-be2c-f519c754ab06"),
                            AccessFailedCount = 0,
                            ApplicationUserRoleId = new Guid("12359876-5423-1564-8957-8215647acdfa"),
                            ConcurrencyStamp = "8ee2429d-821d-4312-9649-c5f203ebcd4d",
                        ...
                        new
                        {
                            UserId = new Guid("a959de51-be12-402a-a30f-18ef1a827b36"),
                            AccessFailedCount = 0,
                            ApplicationUserRoleId = new Guid("a75489d7-8542-315f-f961-a254892c8a32"),
                            ConcurrencyStamp = "e3705d53-696e-4dc9-9f89-0ea35463f17c",
                        ...
                        new
                        {
                            UserId = new Guid("5d8dff73-ec05-4088-90af-9cbe4cfb137f"),
                            AccessFailedCount = 0,
                            ApplicationUserRoleId = new Guid("a7548337-8541-515f-f961-a25489212a32"),
                            ConcurrencyStamp = "fd2de556-374f-4c23-aa20-bc256ab3c354",
            ...
            modelBuilder.Entity("DAL.Models.IdentityModels.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "fb25305a-3957-4943-bd39-214946388f4b",
                            RoleName = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("a75489d7-8542-315f-f961-a254892c8a32"),
                            ConcurrencyStamp = "c179be1b-c924-44cc-a1ac-9d96e53eb806",
                            RoleName = "User"
                        },
                        new
                        {
                            RoleId = new Guid("a7548337-8541-515f-f961-a25489212a32"),
                            ConcurrencyStamp = "7f5d8466-c868-4b5b-ba53-fdaa4e1464a9",
                            RoleName = "SuperUser"
                        },
                        new
                        {
                            RoleId = new Guid("12359876-5423-1564-8957-8215647acdfa"),
                            ConcurrencyStamp = "e1fa172a-7a47-4df2-b0f6-9860f62149a1",
                            RoleName = "Moderator"
                        });
                });
