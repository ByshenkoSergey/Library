    ...
    public class AuthorsData
    {
        public static IEnumerable<Author> GetAuthorsData()
        {
            yield return new Author
            {
                ...
                AuthorBiography = "Mauris viverra a mauris at fringilla.Ut quis elit non libero pretium sollicitudin a et dolor.Duis euismod volutpat eros sed facilisis.Nam lorem dui,"+
                "ultricies vitae luctus aliquam"+
                "volutpat vel nisl.In hac habitasse platea dictumst.Pellentesque cursus placerat nisi et condimentum.Etiam eget nisl elementum,"+
